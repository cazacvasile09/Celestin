...
namespace Celestin.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<NasaContext>(o =>
            {
                o.UseSqlServer(Configuration["ConnectionStrings:nasaDBConnectionString"]);
            });

            services.AddMvc(o => o.EnableEndpointRouting = false);

            services.AddScoped<ICelestinRepository, CelestinRepository>();
